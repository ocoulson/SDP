...
class GameStatus(showCode: Boolean) extends Game{
  ...
  /**
    * Represents a loop in the game logic whereby the user attempts to input valid guesses to identify
    * the secret code.
    *
    * @param guessesAndResponses A vector containing the previous guesses of the user and corresponding
    *                            responses generated by the game
    * @param code The secret code that is to be guessed by the user
    */
  ...
  /**
    * Checks whether the same guess has previously been made in the current game by the user.
    *
    * @param guess the current guess
    * @param guessesAndResponses a vector of previous guesses (and responses)
    * @return true if the guess is unique, false if it has been made previously
    */
